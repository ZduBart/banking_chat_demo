                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <img
                            src="https://www.aliorbank.pl/dam/jcr:ccbfbdab-ce69-4dfb-9c3c-e03ac5dcb7e5/infoNina-awatar.png"
                            alt="Infonina"
                            width="120px"
                            height="120px"
                            aria-hidden="true"
                            ...
                            />
                            <h1 className={styles.chatEmptyStateTitle}>Infonina AI asystent</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Zadaj pytanie lub wypróbuj poniższe przykłady</h2>
